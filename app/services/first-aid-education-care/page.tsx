    ...
    <>
      ...
      <main>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="flex-1 min-w-0">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-4xl font-bold text-white mb-6 leading-tight">
                  ...
                  <span className="text-[#ca1254]">&amp; Care Settings</span>
                </h1>
              ...
              <div className="flex-shrink-0 w-full lg:w-[420px]">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/40 aspect-[4/3]">
                  ...
                  <div className="absolute top-[12px] left-[12px] image-badge">
                    <Baby className="w-4 h-4 text-[#ca1254]" />
                    HLTAID012 Certified
                  </div>
                </div>
              </div>
            ...
            <Reveal>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {paediatricTopics.map((t) => (
                  <div key={t.label} className="flex flex-col items-center gap-3 p-5 rounded-2xl bg-[#3b3f69]/[0.04] border border-[#3b3f69]/10 hover:border-[#ca1254]/30 hover:bg-[#ca1254]/[0.03] transition-colors">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-2xl p-8 border border-[#E8E8F0] shadow-sm">
                  <div className="w-10 h-10 rounded-xl bg-[#ca1254]/10 flex items-center justify-center mb-5">
                    <Baby className="w-5 h-5 text-[#ca1254]" />
                  </div>
                ...
                <div className="bg-white rounded-2xl p-8 border border-[#E8E8F0] shadow-sm">
                  <div className="w-10 h-10 rounded-xl bg-[#3b3f69]/10 flex items-center justify-center mb-5">
                    <GraduationCap className="w-5 h-5 text-[#3b3f69]" />
                  </div>
        ...
        <section className="py-20 bg-[#3b3f69] relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.02] pointer-events-none" style={{ backgroundImage: 'transparent', backgroundSize: '32px 32px' }} />
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-transparent blur-3xl" />
          <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-transparent blur-3xl" />
          <div className="relative mx-auto max-w-[1200px] px-6 lg:px-12">
            <Reveal>
              ...
              <p className="text-white/80 text-base leading-relaxed mb-8 max-w-2xl">We deliver the HLTAID012 course in formats that suit education and care settings, with practical components essential for compliance.</p>
            ...
            <Reveal>
              ...
              <div className="flex flex-wrap gap-2.5">
                {["Childcare educators", "Early childhood workers", "Teachers and school staff", "Education support workers", "Preschool staff", "Family day care providers", "Out-of-school-hours care staff", "Anyone working with children"].map((item) => (
                  <span key={item} className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#F7F7FA] border border-[#E8E8F0] text-[#333333] font-medium text-sm hover:bg-[#3b3f69]/[0.04] hover:border-[#3b3f69]/20 transition-colors">
