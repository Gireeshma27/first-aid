    ...
    <>
      ...
      <main>
        ...
        <section className="py-20 bg-[#3b3f69] relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-[#ca1254]/5 blur-3xl" />
          <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-[#3b3f69]/5 blur-3xl" />
