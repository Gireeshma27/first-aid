...
const values = [
  {
    ...
    accentBg: "bg-[#ca1254]/8",
    accentIcon: "text-[#ca1254]",
    hoverBg: "group-hover:bg-[#ca1254]",
    borderColor: "border-t-[#ca1254]",
  },
  {
    icon: Target,
    ...
    accentBg: "bg-[#3b3f69]/8",
    accentIcon: "text-[#3b3f69]",
    hoverBg: "group-hover:bg-[#3b3f69]",
    borderColor: "border-t-[#3b3f69]",
  },
  {
    icon: Users,
  ...
  return (
    <>
      ...
      <main>
        ...
        >
          {/* Decorative blobs */}
          <div className="absolute -top-32 -right-32 w-[700px] h-[700px] rounded-full bg-[#ca1254]/8 blur-3xl pointer-events-none" />
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <div className="space-y-8">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-white leading-[1.15] tracking-tight">
                  ...
                  <span className="text-[#ca1254]">Emergency Response</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4 pt-4 border-t border-white/10">
                  <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white/10 border border-white/20">
                    <Award className="w-4 h-4 text-[#ca1254]" />
              ...
              <div className="relative">
                ...
                <div className="absolute -left-4 md:-left-8 bottom-14 bg-white rounded-xl p-4 shadow-2xl border border-gray-100 hidden sm:flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#3b3f69] flex items-center justify-center shadow-lg flex-shrink-0">
        ...
        <section className="py-20 bg-white overflow-hidden relative">
          <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: "transparent", backgroundSize: "50px 50px" }} />
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 relative z-10">
              ...
              {([Clock, Users, Building2, Heart] as const).map((Icon, i) => (
                <div key={stats[i].label} className="bg-white flex flex-col items-center text-center px-6 py-8">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${
                    i % 2 === 0 ? "bg-[#3b3f69]/10" : "bg-[#ca1254]/10"
                  }`}>
                    <Icon className={`w-5 h-5 ${i % 2 === 0 ? "text-[#3b3f69]" : "text-[#ca1254]"}`} />
                  </div>
        ...
        <section className="py-20 bg-[#F5F5F5] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#3b3f69] rounded-full blur-3xl pointer-events-none -z-1" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#3b3f69] rounded-full blur-3xl pointer-events-none -z-1" />
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 relative z-10">
            <div className="text-center mb-10 md:mb-14">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl font-bold text-[#333333] tracking-tight leading-tight">
                What Drives Us
              </h2>
              </Reveal>
            </div>
        ...
        <section className="py-20 bg-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: "transparent", backgroundSize: "40px 40px" }} />
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <Reveal>
              <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#ca1254]/8 text-[#ca1254] text-sm font-semibold mb-4">
                <span className="w-2 h-2 rounded-full bg-[#ca1254]" />
                Our History
              </span>
              <h2 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl font-bold text-[#333333] tracking-tight leading-tight">
            ...
            <div className="relative">
              ...
              <div className="absolute left-7 top-7 bottom-0 w-0.5 bg-[#3b3f69] lg:hidden" />
              {/* Desktop  horizontal connector line */}
              <div className="hidden lg:block absolute top-7 left-[calc(100%/12)] right-[calc(100%/12)] h-0.5 bg-[#3b3f69]" />
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div
                  ...
                  style={{ background: "#3b3f69" }}
                >
                  <div className="absolute top-0 right-0 w-72 h-72 rounded-full bg-[#ca1254]/10 blur-3xl pointer-events-none" />
                  <div
                    className="absolute inset-0 opacity-[0.04]"
...
>
                    ...
                    <p className="text-5xl font-black text-[#ca1254] tracking-tight mb-6">91222</p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#3b3f69]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#3b3f69]" />
                      </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="group bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-base md:text-lg font-bold text-[#333333] mb-2 group-hover:text-[#3b3f69] transition-colors">{item.title}</h3>
        ...
        {/*  Who We Work With  */}
        <section className="py-20 bg-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.015]" style={{ backgroundImage: "transparent", backgroundSize: "40px 40px" }} />
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 relative z-10">
            <div className="text-center mb-10">
              <Reveal>
              <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#ca1254]/8 text-[#ca1254] text-sm font-semibold mb-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {([
                ...
                <div
                  key={item.label}
                  className="flex items-start gap-4 p-5 rounded-2xl bg-[#F7F7FA] border border-[#E8E8F0] hover:border-[#3b3f69]/20 hover:bg-white hover:shadow-md transition-all duration-300"
                >
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${
                    item.primary ? "bg-[#3b3f69]/10" : "bg-[#ca1254]/10"
                  }`}>
                    <item.icon className={`w-5 h-5 ${item.primary ? "text-[#3b3f69]" : "text-[#ca1254]"}`} />
                  </div>
                  <div>
