...
export async function POST(req: NextRequest) {
  try {
    ...
    const { fullName, organisation, phone, email, message } = body
    ...
    // Email to Admin — contact enquiry notification
    const msg = {
        ...
        <div style="font-family: Inter, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #ffffff; border: 1px solid #e5e5e5; border-radius: 12px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0; color: #333333; font-size: 14px;">${phone || "N/A"}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 12px 0; color: #333333; font-size: 14px;">${message}</td>
            </tr>
          </table>
          <div style="margin-top: 32px; padding: 16px; background: #f9f9f9; border-radius: 8px; text-align: center;">
            <p style="margin: 0; color: #999999; font-size: 12px;">First Aid Network Australia | Contact Enquiry</p>
          </div>
        </div>
      `,
      replyTo: email,
